...
namespace ClashRoyaleApi.API.Models
{
    ...
    public partial class TournamentItem
    {
        /// <summary>
        ...
        /// Initializes a new instance of the TournamentBaseItemsItem class.
        /// </summary>
        public TournamentItem(string tag = default(string), string type = default(string), string status = default(string), string creatorTag = default(string), string name = default(string), string description = default(string), int? capacity = default(int?), int? maxCapacity = default(int?), int? preparationDuration = default(int?), int? duration = default(int?), DateTime createdTime = default(DateTime))
        {
            Tag = tag;
            Type = type;
            Status = status;
